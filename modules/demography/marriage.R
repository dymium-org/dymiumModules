# It is recommended to assign this module to a variable called: event_demography_marriage
# for example: event_demography_marriage <- modules::use('modules/demography/marriage.R')
