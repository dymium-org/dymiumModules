# It is recommended to assign this module to a variable called: event_demography_age
# for example: event_demography_age <- modules::use('modules/demography/age.R')
