# It is recommended to assign this module to a variable called: event_demography_emigrate
# for example: event_demography_emigrate <- modules::use('modules/demography/emigrate.R')
