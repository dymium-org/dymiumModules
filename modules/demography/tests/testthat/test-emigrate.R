...
#       to run this test use # test_file('modules/demography/tests/testthat/test-emigrate.R')
# import the module
library(dymiumCore)
# set logger's threshold to 'warn' to mute info level loggings
dymiumCore:::lg$set_threshold(level = 'warn')
event_demography_emigrate <- modules::use(here::here('modules/demography/emigrate.R'))
