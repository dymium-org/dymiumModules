# It is recommended to assign this module to a variable called: event_demography_separate
# for example: event_demography_separate <- modules::use('modules/demography/separate.R')
